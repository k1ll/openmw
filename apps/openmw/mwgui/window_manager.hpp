...
namespace MWGui
{
  ...
  public:
    ...
    WindowManager(const Compiler::Extensions& extensions, int fpsLevel, int tabCompletionMode, bool newGame, OEngine::Render::OgreRenderer *mOgre, const std::string logpath);
